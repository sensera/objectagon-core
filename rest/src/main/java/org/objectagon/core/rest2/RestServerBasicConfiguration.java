 ...
 */
public class RestServerBasicConfiguration {
    ...
    private Task initialize() {
        ...
        restServices.initialize(sequence);
    ...
    public class TestUser extends AbstractReceiver<Address> {
        ...
        public void configure(Configurations... configurations) {
            ...
            TestUserConfig testUserConfig = FindNamedConfiguration.finder(configurations).getConfigurationByName(TEST_USER);
        ...
        public SearchServiceProtocol.Send createSearchProtocol() {
            SearchServiceProtocol searchServiceProtocol = server.createReceiver(SearchServiceProtocol.SEARCH_SERVICE_PROTOCOL);
        ...
        public org.objectagon.core.rest.RestServiceProtocol.Send createRestServiceProtocol() {
            Address restServiceAddress = null; //TODO Implement me
            org.objectagon.core.rest.RestServiceProtocol restServiceProtocol = server.createReceiver(org.objectagon.core.rest.RestServiceProtocol.REST_SERVICE_PROTOCOL);
