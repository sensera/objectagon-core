...
public interface FieldValue extends Entity<FieldValue.FieldValueIdentity, FieldValue.FieldValueData> {
    ...
    Message.Field FIELD_VALUE_IDENTITY = NamedField.address("fieldValueIdentity");
    Message.Field VALUE = NamedField.values("value");
    ...
    interface FieldValueData extends Data<FieldValueIdentity, StandardVersion> {
    ...
    interface ChangeFieldValue extends Data.Change<FieldValueIdentity,StandardVersion> {
