...
public class InstanceProtocolImpl extends AbstractProtocol<InstanceProtocol.Send, Protocol.Reply> implements InstanceProtocol {
    ...
    class InstanceProtocolAlter extends AbstractProtocolSend implements Alter {
    ...
    class InstanceProtocolInternal extends AbstractProtocolSend implements Internal {
