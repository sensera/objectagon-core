...
public interface InstanceClass extends Entity<InstanceClass.InstanceClassIdentity, InstanceClass.InstanceClassData> {
    ...
    interface InstanceClassData extends Data<InstanceClassIdentity, StandardVersion> {
    ...
    interface ChangeInstanceClass extends Data.Change<InstanceClassIdentity,StandardVersion> {
