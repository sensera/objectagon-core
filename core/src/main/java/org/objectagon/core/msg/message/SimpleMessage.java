...
public class SimpleMessage extends AbstractMessage implements Message {
    ...
    public SimpleMessage setValue(Field field, Address address) {
        return setValue(field, VolatileAddressValue.address(field, address));
    }
    ...
    public SimpleMessage setValue(Field field, String text) {
        return setValue(field, VolatileTextValue.text(field, text));
    }

    public SimpleMessage setValue(Field field, Message.MessageName message) {
        return setValue(field, VolatileMessageValue.messageName(field, message));
    }

    public SimpleMessage setValue(Field field, Message.MessageName message, Iterable<Value> values) {
        return setValue(field, MessageValue.message(field, message, values));
    }
