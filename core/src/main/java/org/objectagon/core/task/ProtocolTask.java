...
public class ProtocolTask<S extends Protocol.Send> extends AbstractTask {
    ...
    public ProtocolTask(ReceiverCtrl taskCtrl, TaskName taskName, Protocol.ProtocolName protocolName, Address target, SendMessageAction<S> sendMessageAction) {
    ...
    public ProtocolTask(ReceiverCtrl taskCtrl, TaskName taskName, Protocol.ProtocolName protocolName, Composer composer, SendMessageAction<S> sendMessageAction) {
        super(taskCtrl, taskName);
        this.protocolName = protocolName;
